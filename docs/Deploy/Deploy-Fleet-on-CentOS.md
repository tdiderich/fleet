...
To install Fleet, [download](https://github.com/fleetdm/fleet/releases), unzip, and move the latest Fleet binary - file labeled `Source code
(zip)` - to your desired install location.

After downloading, you will rename, unzip, and make it executable:
```sh
